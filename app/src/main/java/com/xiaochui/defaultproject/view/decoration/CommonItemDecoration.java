...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommonItemDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public CommonItemDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public CommonItemDecoration(int space, Drawable mDivider) {
        this.space = space;
